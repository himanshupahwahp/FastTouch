...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li id="Postad" class="nav-item">
        <a class="nav-link" href="addPost.php" onclick="setId('Postad')">Post Ad</a>
      </li>
      <li id="MyPosts" class="nav-item">
        <a class="nav-link" href="my_posts.php" onclick="setId('MyPosts')">My Posts</a>
      </li>
      ...
      <li id="Plans" class="nav-item">
        <a class="nav-link" href="my_contracts.php">My Contracts</a>
      </li>
      <li class="nav-item">
